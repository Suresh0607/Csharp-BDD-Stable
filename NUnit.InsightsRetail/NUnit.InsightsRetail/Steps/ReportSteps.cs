...
namespace NUnit.InsightsRetail.Steps
{
    ...
    {
       //private Login_Page login_page => new Login_Page(_driver);
        ...
        public ReportSteps(IWebDriver driver, ScenarioContext scenarioContext,FeatureContext featureContext)
        {
            this._driver = driver;
